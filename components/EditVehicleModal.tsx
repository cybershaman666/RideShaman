      ...
      <div className="bg-slate-800 rounded-lg shadow-2xl w-full max-w-md relative">
        <div className="flex justify-between items-center p-6 border-b border-slate-700">
          <h2 className="text-xl font-semibold">
            {t('vehicles.edit.title')}: <span className="text-amber-400">{vehicle.name}</span>
          </h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between items-center p-6 bg-slate-900/50 border-t border-slate-700 rounded-b-lg">
            ...
            <div className="space-x-3">
                ...
                <button type="submit" className="px-4 py-2 text-sm font-medium rounded-md shadow-sm text-white bg-amber-600 hover:bg-amber-700 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-slate-800">{t('general.saveChanges')}</button>
            </div>
          </div>
        </form>
      </div>
